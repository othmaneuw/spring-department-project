...
import com.othmane.SpringBoot.tutorial.repository.DepartmentRepository;
...
class DepartmentServiceTest {
    ...
    public void whenValidDepartmentName_thenReturnDepartment(){
        Department found = departmentService.fetchDepartmentByName("IT");
